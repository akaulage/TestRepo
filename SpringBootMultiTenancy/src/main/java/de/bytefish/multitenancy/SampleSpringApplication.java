...
public class SampleSpringApplication {
    ...
    public DataSource tenantOne() {
        ...
        //dataSource.addDataSourceProperty("url", "jdbc:postgresql://127.0.0.1:3306/sampledb");
        dataSource.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/test");
        dataSource.addDataSourceProperty("user", "root");
        dataSource.addDataSourceProperty("password", "root@123");
    ...
    public DataSource tenantTwo() {
        ...
        dataSource.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/test1");
        dataSource.addDataSourceProperty("user", "root");
        dataSource.addDataSourceProperty("password", "root@123");
